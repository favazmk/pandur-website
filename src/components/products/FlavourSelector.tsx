  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden transition-colors duration-1000 ease-in-out" style={{ backgroundColor: activeScene.bg }}>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-1 lg:order-2 relative h-[50vh] lg:h-[80vh] flex items-center justify-center pointer-events-none">
          <AnimatePresence mode="popLayout">
            ...
            >
              <img 
                ...
                className="w-full aspect-square object-cover rounded-[2rem] drop-shadow-2xl"
              />
            </motion.div>
          </AnimatePresence>
        </div>
