...
export default function WhatsAppCTA({
  ...
  const variants = {
    ...
    secondary: "bg-cream text-ink border border-ink/10 hover:border-red-deep/30 hover:bg-white hover:text-red-deep shadow-sm",
    outline: "bg-transparent text-ink border border-ink hover:border-red-deep hover:text-red-deep",
  };
